...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.score.setText(Utilies.getScores(homescore, awayscore));
        ...
        view.setContentDescription(context.getString(R.string.a11y_scores_readout, mHolder.home_name.getText(), mHolder.away_name.getText(), homescore, awayscore , mHolder.date.getText()));
